...
# Задание 3-е
# Дан набор данных с количеством авиапассажиров компании помесяцам
# за несколько лет (csv файл приложен к работе).
# Без использования Pandas c помощью matplotlib  построить график
# пассажиропотока за все время (линейный график) и распределение
# пассажиров по месяцам в 1951 - 1955 гг. (гисторамма)
